	...
	public class RandomMapV2 : MonoBehaviour {
		...
		public class FloorMapSetting
		{
			...
			public FloorMapSetting()
			{
				...
				blocks[2]=new floorBlockSetting(20,40,new float[3]{0.5f,0.75f,1f},2,2,4,0,new floorPlacing[1]{new floorPlacing(1,0,0)});
				blocks[3]=new floorBlockSetting(40,70,new float[3]{0.25f,0.75f,1f},2,2,4,0, new floorPlacing[0]);
				blocks[4]=new floorBlockSetting(70,100,new float[3]{0f,1f,1f},2,3,4,0,new floorPlacing[1]{new floorPlacing(0,0,0)});
				blocks[5]=new floorBlockSetting(100,300,new float[3]{0f,0.75f,1f},0,3,4,0, new floorPlacing[1] { new floorPlacing(1, 0, 0) });
			}
		}
